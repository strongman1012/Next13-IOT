      ...
      >
        <div className="flex justify-between items-center h-full">
          ...
          <div className="nav-tools flex items-center lg:space-x-6 space-x-3 rtl:space-x-reverse">
            ...
            {navBarConfig.showDarkMode && (
            <SwitchDark />
            )}
            {navBarConfig.showMonochrome && (
            <MonoChrome />
            )}
            {navBarConfig.showMail && width >= breakpoints.md && <Message />}
            {navBarConfig.showNotifications && width >= breakpoints.md && <Notification />}
